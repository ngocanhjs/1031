...
fig_1 = px.histogram(data.loc[data['MAIN_PRODUCTION'].isin(slice1.index)],
                      x='SCORE',
                      color='MAIN_PRODUCTION',
                      nbins=20)

fig_2 = px.histogram(data.loc[data['MAIN_PRODUCTION'].isin(slice2.index)],
                      x='SCORE',
                      color='MAIN_PRODUCTION',
                      nbins=20)

fig_3 = px.histogram(data.loc[data['MAIN_PRODUCTION'].isin(slice3.index)],
                      x='SCORE',
                      color='MAIN_PRODUCTION',
                      nbins=20)
...
def update_bar_chart(value):
    ...
    fig_1 = px.histogram(data.loc[data['MAIN_PRODUCTION'].isin(df_bar.iloc[:2].index)],
                          x='SCORE',
                          color='MAIN_PRODUCTION',
                          nbins=20)

    fig_2 = px.histogram(data.loc[data['MAIN_PRODUCTION'].isin(df_bar.iloc[2:4].index)],
                          x='SCORE',
                          color='MAIN_PRODUCTION',
                          nbins=20)

    fig_3 = px.histogram(data.loc[data['MAIN_PRODUCTION'].isin(df_bar.iloc[4:6].index)],
                          x='SCORE',
                          color='MAIN_PRODUCTION',
                          nbins=20)
