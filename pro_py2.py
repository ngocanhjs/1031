...
app.layout = dbc.Container([
    ...
    html.H1('NETFLIX TV SHOW DATA VISUALIZATION', 
    ...
    dbc.Row([
        ...
        html.H2('The Distribution of Main Genre', 
        ...
        dbc.Col([
            ...
            dcc.Dropdown(
                ...
                options=[{"label": option, 
                          "value": option} for option in data["MAIN_GENRE"].unique()],
                value="drama"
            ),
...
@app.callback(Output('plot-bar', 'figure'), 
              [Input('slider', 'value')])
