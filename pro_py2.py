...
# Create the box chart (left plot)

fig_sub_box = px.box(data, x="MAIN_GENRE", y="SCORE", color="MAIN_GENRE",

                  title="The sub box chart demonstrates the distribution of range score of TV shows according to TV show genres",
...
fig_sub_box.update_layout(xaxis=dict(categoryorder='array', categoryarray=sorted_genre))


# Create the scatter plot (right plot)
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col(html.Div([
            ...
            dcc.Graph(id="plot-sub-box", figure=fig_sub_box, style={'height': 750})

        ]), width={'size': 4, 'offset': 0, 'order': 2}),

        

        # Scatter plot (right plot)
...
def update_sub_box_chart(genre_selection):
